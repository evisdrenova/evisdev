...
Hopefully by now you have a good understanding of activation functions and why they are so important in neural networks so let's do a little history lesson.
