...
Now for the beauty of scalar multiplication with abelian groups on elliptic curves that makes this whole thing work.

We can string together many of these scalar multiplication operations together and it's fast! In fact, we can perform them in constant-time.
