...
They are still these rectangular devices that demand we bow our heads to in deference in order to send a text, read an article and make a phone call. In general, the way that we have interacted with these devices has been:

1. I look at screen
2. I type command
3. Computer does something while I watch
4. I reason if it did the right thing and then respond accordingly
