...
There is still a screen that we imperatively type in commands and our devices determinstiically perform those commands. Our brains act as the reasoning engine to resolve our high level goals into imperative commands that our fingers encode into text. 



In our past world where our personal computing devices are deterministic, we, the humans, are the reasoning engines that instruct our devices. And those devices do exactly as we ask. 

But this is changing. With AI, we no longer have to imperatively instruct our deterministic devices, instead we can instruct

 instruct our devices to do things, we can instruct 
