---
title: "Porting Llama2.c to Rust"
date: "2025-09-27"
publish: true
---

This is a rust port of [Karpathy's llama2.c](https://github.com/karpathy/llama2.c) tiny and simple inference engine written in pure c. I thought it would be fun to port this to rust to improve my own learning. I also wanted to take some notes of my thought process as I'm doing this.
