...
We almost have sound. The final step is to convert the amplified electrical energy into mechanical energy, the physical vibrations of sounds waves. This is the job of a **transducer**.

![speaker](/speaker.png)

(I pushed my excalidraw skills to the limit so I found this one on the internet)
